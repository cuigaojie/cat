...
export default new Vuex.Store({
        ...
        ipt_Info:{name:'',endTime:'有效期',licenceId:'',licenceName:'',licenceAddress:'',  endDate:'2999-12-30', startDate:'',
        ...
        ipt_Info3:{orderName:'',linkName:'',email:'',work:[],address:[],detailAddress:'',phone:'',provid:'',cityid:'',districtid:''},
